...
class DiveGraphsAdapter internal constructor(context: Context) : RecyclerView.Adapter<DiveGraphsAdapter.DiveViewHolder>() {
    ...
    {
        val diveDateView: TextView = itemView.findViewById(R.id.date_graphs)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DiveViewHolder {
        val itemView = inflater.inflate(R.layout.cardview_item_graphs, parent, false)
